...
function Desc(){
  ...
  switch(droga){
    case 'Nenhuma':
      ...
      document.querySelector('#receptorTA1').src = '../assets/images/simulador-metabolismo/receptores/beta3-basal.png'
    ...
    case 'Noradrenalina':
      ...
      document.querySelector('#receptorTA1').src = '../assets/images/simulador-metabolismo/receptores/beta3-ativado.png'
