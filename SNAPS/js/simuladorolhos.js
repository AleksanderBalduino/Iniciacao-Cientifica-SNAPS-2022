...
function Desc(){
  ...
  switch(droga){
    ...
    case 'Noradrenalina':
        ...
        switch(detail){
          case 'Efeitos':
            document.getElementById('detailarea').value = 'Contração do músculo radial da íris, resultando em midríase.'
          break;
        }
    break;
    ...
    case 'Acetilcolina':
        ...
        switch(detail){
          case 'Efeitos':
            document.getElementById('detailarea').value = 'Contração do músculo do esfíncter da íris, resultando em miose.'
          break;
        }
    break;
  }  
